...
export default function BotonesScreen() {
    ...
    const texto = modoOscuro ? styles.darkTheme : styles.lightText; // Y después de los dos puntos es como si fuera un false 
    //.A esta linea se le conoce como "valor terneareo"
